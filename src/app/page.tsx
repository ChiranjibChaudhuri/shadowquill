  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center px-4"> {/* Adjust height based on header/footer */}
      ...
      <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl">
        Your AI-powered assistant for crafting compelling stories. Follow the stages below to build your world, create characters, outline your plot, and write your book.
      </p>
      ...
      <p className="mt-12 text-sm text-gray-500">
        Use the navigation bar above to jump between stages. Your progress is saved locally in your browser.
      </p>
    </div>
  );
}
